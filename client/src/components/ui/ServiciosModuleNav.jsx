...
const MODULES = [
  { label: "Piscina", href: "/piscina/ingresos", icon: Waves    },
  { label: "Eventos", href: "/eventos/calendario", icon: Sparkles },
];

const MODULE_PREFIXES = [
  { prefix: "/piscina",  moduleHref: "/piscina/ingresos"    },
  { prefix: "/eventos",  moduleHref: "/eventos/calendario"  },
];
...
export function ServiciosModuleNav() {
